...
public class ShopReviewUpdateService implements ShopServiceinter{
	
	
    private ShopIDao iDao;
    public ShopReviewUpdateService(ShopIDao iDao) {
        this.iDao=iDao;
    }
    ...
    public void execute(Model model) {
        ...
        String review_content=request.getParameter("review_content");
     	...
     	//리뷰 수정하기
      	iDao.review_update(reviewid,review_title,review_content);
    }
}
