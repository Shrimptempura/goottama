...
public class ShopReviewUpdateViewService implements ShopServiceinter{
	
	
    private ShopIDao iDao;
    public ShopReviewUpdateViewService(ShopIDao iDao) {
        this.iDao=iDao;
    }
    ...
    public void execute(Model model) {
        ...
        String review_id=request.getParameter("review_id");
     	...
     	//리뷰 검색
      	ShopReviewFlatDto shopReviewFlatDto=iDao.review(reviewid);
      	
      	model.addAttribute("review",shopReviewFlatDto);
