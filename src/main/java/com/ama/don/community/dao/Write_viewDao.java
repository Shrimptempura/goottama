...
public class Write_viewDao {
	...
	public void write(String post_title, String post_content, String post_img) {
		...
		try {
			...
			String query = "insert into post (post_id, user_id, post_title, post_content, post_date, post_count, post_like_count, post_img, target_type, target_id)\r\n"
					+ "values (2,101, ?, ?, now(), 0, 0, ?, 0, 0);";
